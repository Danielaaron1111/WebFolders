...
describe('ReadMe documentation', () => {
    ...
    it('should have the prompt for the student name in the third or fourth line as indicated', () => {
        const lines = contents.split(newline);
        const index = lines[0].includes('https://classroom.github.com') ? 3 : 2;
        expect(lines[index], 'The third or fourth line should start with "> Your Name:"').toMatch(/> Your Name:/);
    })
});
